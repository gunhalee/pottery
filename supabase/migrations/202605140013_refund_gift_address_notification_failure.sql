...
revoke all on function public.mark_shop_order_refunded_after_notification_failure(uuid, text, jsonb, text)
from public, anon, authenticated;

grant execute on function public.mark_shop_order_refunded_after_notification_failure(uuid, text, jsonb, text)
to service_role;
