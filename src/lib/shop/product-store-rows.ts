...
export const productRowSchema = z.object({
  ...
  made_to_order_available: z.boolean(),
  made_to_order_days_max: z.number().int().positive(),
  made_to_order_days_min: z.number().int().positive(),
  made_to_order_notice: z.string().nullable(),
  material: z.string().nullable(),
  plant_care_notice: z.string().nullable(),
  plant_option_enabled: z.boolean(),
  plant_option_price_delta_krw: z.number().int().nonnegative(),
  plant_return_notice: z.string().nullable(),
  plant_shipping_restriction_notice: z.string().nullable(),
  plant_species: z.string().nullable(),
  price_krw: z.number().int().nonnegative().nullable(),
  purchase_limit_quantity: z.number().int().nonnegative().nullable(),
  published: z.boolean(),
